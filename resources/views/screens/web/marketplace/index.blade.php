    ...
    <div class="container">
        <div class="row mb-40">
            <div class="col-8 text-center mx-auto">
                ...
                <p class="para">
                    Welcome to the League Marketplace — a trusted space where verified contractors can buy, sell, and trade products and services within the professional community.
                </p>
            </div>
        </div>
        ...
        <div class="row mb-40">
            <div class="col-12">
                <ul class="nav nav-tabs justify-content-center" id="marketplaceTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="technology-tab" data-bs-toggle="tab" data-bs-target="#technology" type="button" role="tab" aria-controls="technology" aria-selected="false">
                            Technology & Software
                        </button>
                    </li>
                </ul>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="con-place-card-wrapper marketplace-card-wrapper">
                            ...
                            <div class="content-wrapper">
                                ...
                                <p class="text-white mb-20">Power tools, safety gear, rentals, and accessories</p>
                                <a href="" class="btn btn-outline btn-sm">Explore Products</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
