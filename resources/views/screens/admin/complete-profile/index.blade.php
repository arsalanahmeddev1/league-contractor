...
@section('content')
    <div class="container-fluid">
        <div class="edit-profile">
            <form class="card" id="createCompanyProfileForm" action={{ route('company-profile.store') }} method="POST">
                @csrf
                ...
                <div class="card-body">
                    <div class="row custom-input">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label" for="insurance">Insurance</label><input class="form-control @error('insurance') is-invalid @enderror" id="insurance"
    ...
    @push('scripts')
        <script>
            ajaxCreate('#createCompanyProfileForm', "{{ route('admin.dashboard') }}");
        </script>
    @endpush
@endsection
