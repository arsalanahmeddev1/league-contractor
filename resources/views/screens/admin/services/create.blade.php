...
<div class="container-fluid">
    <div class="edit-profile">
        <form class="card" id="createServiceForm" action="#" method="POST">
            @csrf
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="duration"
                                type="text" placeholder="Enter Duration (e.g., 2 hours)" name="duration" />
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" rows="3"
                                placeholder="Enter Service Description" name="description"></textarea>
                        </div>
                    </div>
                </div>
            </div>
